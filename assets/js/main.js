...
(() => {
  ...
  const I18N = {
    fr: {
      ...
      'about.p1': "Je crée des sites vitrines pour artisans et TPE, partout en France. Pas d'intermédiaire : je dessine, je code, je mets en ligne.",
      'about.p2': "Un site rapide, clair, qui ramène des clients. Vous validez chaque étape — le site est à vous à 100 %.",
      ...
      'pledge.p1.text': "Maquette taille réelle au jour 2-3. Je code après votre accord.",
      'pledge.p2.title': "Livré en 7 jours",
      'pledge.p2.text': "Le délai court dès la maquette validée. Il figure sur le devis.",
      'pledge.p3.title': "Le site vous appartient à 100%",
      'pledge.p3.text': "Code, domaine, accès : tout à votre nom. Zéro abonnement imposé.",
      'pledge.p4.title': "Paiement en 2× sans frais",
      'pledge.p4.text': "50 % à la commande, 50 % au site en ligne, validé par vous.",
      ...
      'hero.sub': "Un site pro qui transforme les recherches Google en appels. Pour artisans et TPE.",
      'hero.price.amount': "Dès 390 € TTC",
      'hero.price.terms': 'Paiement en 2× sans frais',
      'hero.cta1': 'Demander un devis gratuit',
      'hero.stat3': "Voir les 8 démos",
      'hero.scroll': 'Défiler',
      'hero.avail': "Studio solo — places limitées chaque mois",
      'hero.reply24': "à vous pour toujours",
      /* Works */
      'works.title.l1': "Exemples de sites",
      'works.title.l2': "par métier",
      'works.sub': "8 démonstrations Clicboost, une par métier : ce que vous auriez pour 390 à 890 €.",
      'works.seo': "Site vitrine, référencement local : chaque démo est un vrai site en ligne.",
      'work.demo': "Site démo",
      ...
      'work.av.desc': "Sur chantier, vous ratez des appels : le site prend les devis 24h/24.",
      ...
      'work.pd.desc': "Le client haut de gamme juge en 8 secondes. Vidéo, RDV en 3 clics.",
      ...
      'work.me.desc': "Le site retient dès le premier écran : vidéo immersive, RDV en ligne.",
      ...
      'work.ap.desc': "Fuite à 23h : bouton d'urgence permanent, pages par arrondissement.",
      ...
      'work.cl.desc': "Chaque pièce présentée comme en galerie, loin des géants du web.",
      ...
      'work.vc.desc': "Site trilingue FR-EN-ES, RDV en 2 minutes, urgences 7j/7.",
      ...
      'work.mt.desc': "Le formulaire pré-qualifie vos prospects avant le premier appel.",
      ...
      'work.mo.desc': "Hero vidéo, galerie filtrée par coupe, RDV qui pré-qualifie.",
      ...
      'services.compare': "Abonnement : 50 €/mois, 1 800 € sur 3 ans, jamais à vous. Ici : payé une fois, à vous.",
      'services.p2.f6': "Textes rédigés avec vous",
      'addons.eyebrow': 'Après la mise en ligne',
      'addons.title': 'Faites vivre votre site',
      'addons.sub': "Restez visible : à la carte, sans engagement, résiliable à tout moment.",
      ...
      'calc.sub': "Réglez les curseurs : estimation immédiate, volontairement prudente.",
      ...
      'calc.res.days': "jours",
      'calc.cta': "Obtenir mon devis gratuit",
      ...
      'process.s1.text': "15 minutes d'échange, un plan clair — même sans travailler ensemble.",
      'process.s2.time': 'Maquette (Jour 2-3)',
      'process.s2.title': 'Maquette',
      'process.s2.text': "Votre site en taille réelle. Vous validez tout avant que je code.",
      'process.s3.time': 'Développement (Jour 4-6)',
      'process.s3.title': 'Développement',
      'process.s3.text': "Je code votre site : HTML propre, rapide, zéro dépendance inutile.",
      'process.s4.time': 'Mise en ligne (Jour 7)',
      'process.s4.title': 'Mise en ligne',
      'process.s4.text': "Site en ligne + 30 min de formation. Vous modifiez tout vous-même.",
      /* FAQ */
    ...
    en: {
      ...
      'about.p1': "I build showcase websites for tradespeople and small businesses across France. No middleman: I design, I code, I put it live.",
      'about.p2': "A fast, clear site that brings in clients. You approve every step — the site is 100% yours.",
      ...
      'pledge.p1.text': "Full-size mockup by day 2-3. I code only after you approve.",
      'pledge.p2.title': "Delivered in 7 days",
      'pledge.p2.text': "The clock starts at mockup approval. It is on the quote.",
      'pledge.p3.title': "The site is 100% yours",
      'pledge.p3.text': "Code, domain, access: all in your name. No forced subscription.",
      'pledge.p4.title': "Split payment at no cost",
      'pledge.p4.text': "50% on order, 50% once the site is live and approved.",
      ...
      'hero.sub': "A pro website that turns Google searches into calls. For trades and small firms.",
      'hero.price.amount': "From €390 incl. VAT",
      'hero.price.terms': 'Pay in 2× at no extra cost',
      'hero.cta1': 'Request a free quote',
      'hero.stat3': "See the 8 demos",
      'hero.scroll': 'Scroll',
      'hero.avail': "Solo studio — limited slots each month",
      'hero.reply24': "yours forever",
      /* Works */
      'works.title.l1': "Sample websites",
      'works.title.l2': "by trade",
      'works.sub': "8 demonstration sites by Clicboost, one per trade — what you'd get for €390–890.",
      'works.seo': "Showcase site, local SEO: every demo is a real live website.",
      'work.demo': "Demo site",
      ...
      'work.av.desc': "On site, you miss calls: the website takes quote requests 24/7.",
      'work.av.result': "24/7 quote form + local Google optimisation",
      'work.pd.tag1': 'Premium VTC',
      'work.pd.tag2': 'Paris',
      'work.pd.metric': 'Booking in 60s',
      'work.pd.desc': "High-end clients judge in 8 seconds. Video, booking in 3 clicks.",
      ...
      'work.me.desc': "Holds visitors from the first screen: immersive video, online booking.",
      'work.me.result': "Built-in online booking + calming premium design",
      'work.ap.tag1': 'Plumber 24/7',
      'work.ap.tag2': 'Paris',
      'work.ap.metric': "24/7 emergency",
      'work.ap.desc': "Leak at 11pm: permanent emergency button, one page per district.",
      ...
      'work.cl.desc': "Each piece shown like art in a gallery, far from e-commerce giants.",
      ...
      'work.vc.desc': "Trilingual FR-EN-ES site, 2-minute booking, 7-day emergencies.",
      ...
      'work.mt.desc': "The form pre-qualifies your leads before the first call.",
      ...
      'work.mo.desc': "Video hero, gallery filtered by cut, booking that pre-qualifies.",
      ...
      'services.compare': "Subscription: €50/month, €1,800 over 3 years, never yours. Here: pay once, own it.",
      'services.p2.f6': "Copy written with you",
      'addons.eyebrow': 'After going live',
      'addons.title': 'Keep your site alive',
      'addons.sub': "Stay visible: à la carte, no commitment, cancel anytime.",
      ...
      'calc.sub': "Set the sliders: instant estimate, deliberately conservative.",
      ...
      'process.s1.text': "15 minutes, a clear plan — even if we never work together.",
      'process.s2.time': 'Mockup (Days 2-3)',
      'process.s2.title': 'Mockup',
      'process.s2.text': "Your site at full size. You approve everything before I code.",
      'process.s3.time': 'Development (Days 4-6)',
      'process.s3.title': 'Development',
      'process.s3.text': "I code your site: clean HTML, fast, no needless dependencies.",
      'process.s4.time': 'Launch (Day 7)',
      'process.s4.title': 'Launch',
      'process.s4.text': "Site live + 30-minute training. You update everything yourself.",
      /* FAQ */
