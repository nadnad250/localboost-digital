...
(() => {
  ...
  const I18N = {
    fr: {
      ...
      /* Hero */
      'hero.eyebrow': 'Paris · Versailles · Île-de-France',
      ...
      /* À propos */
      'about.eyebrow': 'Paris · Versailles · Île-de-France',
      ...
      'about.photo.tag': 'Disponible · Paris · Versailles',
    ...
    en: {
      ...
      'about.photo.tag': 'Available · Paris · Versailles',
